...
import 'package:star_cano/services/social_mexicano_algorithm_service.dart';

void main() {
  group('SocialMexicanoAlgorithmService', () {
    late SocialMexicanoAlgorithmService service;
    late List<Player> players;
    late List<Court> courts;

    setUp(() {
      service = SocialMexicanoAlgorithmService();
